...
export default function AdditionalExamsModal({ 
  ...
  const handleAddHistopathology = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/add-histopathology`, {
        method: 'POST',
        headers: {
  ...
  const handleAddImaging = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/add-imaging`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer demo-token'
  ...
  const handleAddLaboratory = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/add-laboratory`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer demo-token'
  ...
  const handleRemoveHistopathology = async (index: number) => {
    try {
      const response = await fetch(`${API_BASE_URL}/remove-histopathology`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer demo-token'
  ...
  const handleRemoveImaging = async (index: number) => {
    try {
      const response = await fetch(`${API_BASE_URL}/remove-imaging`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer demo-token'
  ...
  const handleRemoveLaboratory = async (index: number) => {
    try {
      const response = await fetch(`${API_BASE_URL}/remove-laboratory`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer demo-token'
